...
API_ID = int(environ.get('API_ID', '10921186'))
API_HASH = environ.get('API_HASH', '2c77af580840a8c59713f3d533a7318a')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002381517937'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5955441466').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002455912130').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hgsj8582oy:<db_password>@cluster0.8puui.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://hgsj8582oy:<db_password>@cluster0.8puui.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
